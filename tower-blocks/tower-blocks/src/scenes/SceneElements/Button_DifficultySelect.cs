...
namespace UI
{
    ...
    /// Start game button
    /// </summary>
    public class Button_DifficultySelect : MenuButton
    {
        /// <summary>
        ...
        public Button_DifficultySelect(Scene _scene, string _text, int _x, int _y, int _width = 0, int _height = 0) : base (_scene, _text, _x, _y, _width, _height)
        {
        ...
        {
            scene = new Scene_Game(scene.window);
        }
    }
}
